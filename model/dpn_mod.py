...
class DPN(nn.Module):
    ...
    def __init__(self, num_init_features=64, k_R=96, G=32,
                 k_sec=(3, 4, 20, 3), inc_sec=(16,32,24,128), num_classes=16):
    ...
    def forward(self, x):
        ...
        out = F.avg_pool2d(features, kernel_size=(6,3)).view(features.size(0), -1)  # kernel_size was 7 in original dpn
